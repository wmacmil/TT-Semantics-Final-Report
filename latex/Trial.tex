...
\\[\AgdaEmptyExtraSkip]%
\>[0]\AgdaKeyword{data}\AgdaSpace{}%
\AgdaDatatype{Women}\AgdaSpace{}%
\AgdaSymbol{:}\AgdaSpace{}%
\AgdaFunction{CN}\AgdaSpace{}%
\AgdaKeyword{where}\<%
\\
\>[0][@{}l@{\AgdaIndent{0}}]%
\>[2]\AgdaInductiveConstructor{Suzy}\AgdaSpace{}%
\AgdaSymbol{:}\AgdaSpace{}%
\AgdaDatatype{Women}\<%
\\
%
...
\\
\>[0][@{}l@{\AgdaIndent{0}}]%
\>[2]\AgdaInductiveConstructor{WomenHuman}\AgdaSpace{}%
\AgdaSymbol{:}\AgdaSpace{}%
\AgdaDatatype{Women}\AgdaSpace{}%
\AgdaSymbol{→}\AgdaSpace{}%
\AgdaDatatype{Human}\<%
...
\\
\>[0]\AgdaFunction{Walk}\AgdaSpace{}%
\AgdaSymbol{(}\AgdaInductiveConstructor{WomenHuman}\AgdaSpace{}%
\AgdaBound{Suze}\AgdaSymbol{)}\AgdaSpace{}%
\AgdaSymbol{=}\AgdaSpace{}%
\AgdaRecord{⊤}\<%
\\
%
...
\\
\>[0][@{}l@{\AgdaIndent{0}}]%
\>[2]\AgdaFunction{humansWhoWalk}\AgdaSpace{}%
\AgdaSymbol{:}\AgdaSpace{}%
\AgdaRecord{Walks}\AgdaSpace{}%
\AgdaDatatype{Human}\<%
\\
%
\>[2]\AgdaField{Walks.walks}\AgdaSpace{}%
\AgdaFunction{humansWhoWalk}\AgdaSpace{}%
\AgdaSymbol{=}\AgdaSpace{}%
\AgdaFunction{Walk}\<%
\\
%
\\[\AgdaEmptyExtraSkip]%
%
\>[2]\AgdaFunction{Menwalks}\AgdaSpace{}%
\AgdaSymbol{:}\AgdaSpace{}%
\AgdaRecord{Walks}\AgdaSpace{}%
\AgdaDatatype{Men}\<%
\\
